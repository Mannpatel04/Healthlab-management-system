            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<li><a class="nav-link active" href="viewrequest.php">View My Request</a></li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well-block">
                        ...
                        <form method="post" action="reqfeedback.php" name="frmlab">
                            <!-- Form start -->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="name"><b>Feedback</b></label>
                                        <input type=hidden name=txtrid value=<?php echo $rid;?>>
                                        <textarea name="txtfeedback" cols="50" rows="5" class="form-control input-md" placeholder="Enter Your Feedback" required></textarea>
                                    </div>
                                </div>
                                <!-- Text input-->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button id="singlebutton" name="singlebutton" class="new-btn-d br-2">OK</button>
                                    </div>
                                </div>
                            </div>
