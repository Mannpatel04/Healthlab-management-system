			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well-block">
                        ...
                        <form method="post" action="reqlab.php" name="frmlab">
                            <!-- Form start -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="name">Lab Name</label>
                                        <input name="txtlname" type="text" placeholder="Enter Lab Name" class="form-control input-md" required >
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Reg no</label>
                                        <input name="txtreg" type="text" placeholder="Enter Registration number" class="form-control input-md" required>
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="date">Owner Name</label>
                                        <input  name="txtowner" type="text" placeholder="Enter Owner Name" class="form-control input-md" required>
                                    </div>
                                </div>
                                <!-- Select Basic -->
                                <div class="col-md-6">
								 ...
								 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="number" name="txtphoneno" placeholder="Enter Phone no" class="form-control" required maxlength="10" required>
                                ...
                                <!-- Select Basic -->
								 ...
								 <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="appointmentfor">Specialities</label>
                                       <textarea name="txtspecialities" cols="50" rows="5" class="form-control" placeholder="Enter specialities" required></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button id="singlebutton" name="singlebutton" class="new-btn-d br-2">Create Lab</button>
                                    </div>
                                </div>
                            </div>
                        </form>
