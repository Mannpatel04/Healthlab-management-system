			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well-block">
                        ...
                        <form method="post" action="reqpostreq.php" name="frmlab">
                            <!-- Form start -->
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="appointmentfor">Date</label>
                                       <input type="text" name="txtdate" class="form-control"  required value=<?php echo date('d-m-Y'); ?>>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Lab Name</label>
                                        <select name="sellabid" class="form-control input-md">
                                <?php
                                    ...
                                    {
                                        echo "<option value=".$data['labid'].">".$data['labname']."</option>";
                                    }
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Reporttype</label>
                                        <select name="selrid" class="form-control input-md">
                                <?php
                                    include "myconnection.php";
                                    ...
                                    {
                                        echo "<option value=".$data1['reporttypeid'].">".$data1['reportname']."</option>";
                                    }
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="appointmentfor">Remark</label>
                                       <textarea name="txtremark" cols="50" rows="5" class="form-control" placeholder="Enter Your Remark" required></textarea>
									   
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="appointmentfor">Transaction No.</label>
                                       <input type="text" name="txttrans" class="form-control" pattern=[0-9]{2,20} placeholder="Enter Transaction No." required>
									   
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="appointmentfor">Paytm</label>
                                       <img src="qrcode.jpg" width="150" height="150">
                                       <label class="control-label" for="appointmentfor">UPI ID: 7573052215@paytm</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button id="singlebutton" name="singlebutton" class="new-btn-d br-2">Post Request</button>
                                    </div>
                                </div>
                            </div>
