		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					...
					$result1=mysqli_query($connection,$q1) or die("query1 error");
					$count=mysqli_num_rows($result1);
					
					if($count==0)
					{
						
						$q="insert into registration values('$fname','$lname','$em','$pass','$ph','$add','surat','$pin','$dob','Active','$da','$seq','$ans','$area')";
