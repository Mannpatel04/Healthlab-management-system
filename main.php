					...
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="serviceBox">
								...
								<h3 class="title"><a href="changepass.php" class="new-btn-d br-2">Change Password</a></h3>
						...
						<div class="item">
							<div class="serviceBox">
								...
								<h3 class="title"><a href="postreq.php" class="new-btn-d br-2">Post Request</a></h3>
						...
						<div class="item">
							<div class="serviceBox">
								...
								<h3 class="title"><a href="viewrequest.php" class="new-btn-d br-2">View My Request</a></h3>
