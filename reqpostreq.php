		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					...
					$q="insert into request(email,reqdate,labid,reporttypeid,remark,status,area,transactionno,tstatus) values('$em','$da','$lname','$rtype','$remark','Pending','$area','$tno','pending')";
