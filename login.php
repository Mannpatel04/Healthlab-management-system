			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well-block">
                        ...
                        <form method="post" action="reqlogin.php" name="frmlab">
                            <!-- Form start -->
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="txtpass" type="password" placeholder="Enter Password" class="form-control input-md">
                                    </div>
                                </div>
                                <!-- Text input-->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button id="singlebutton" name="singlebutton" class="new-btn-d br-2">Log in</button>
                                    </div>
                                </div>
                            </div>
