                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
					 ...
					 $q="select request.*,labs.labid,labs.labname from request,labs where request.status='Pending' and request.labid=labs.labid and request.tstatus='Pending'";
...
?>
          ...
          while($arr2=mysqli_fetch_array($result2))
          {
            $area=$arr2['area'];
                            ...
                            <td><?php echo $arr['transactionno']; ?></td>
                            <td><?php echo $area; ?></td>
                            <td><a href="ok.php?rid=<?php echo $arr['reqid']; ?>">OK</a></td>
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">List Of Old Request</h4>
                    <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        <tbody>
						 <?php
						 include "myconnection.php";
					 $q="select request.*,labs.labid,labs.labname from request,labs where request.status='Pending' and request.labid=labs.labid and request.tstatus='completed'";
$rexist=mysqli_query($connection,$q) or die("Error");
$count=mysqli_num_rows($rexist);
if($count>0)
{
