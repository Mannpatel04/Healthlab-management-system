            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                <div class="navbar-profile">
                  ...
                  <p class="mb-0 d-none d-sm-block navbar-profile-name">Sub-Admin</p>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" action="reqsubadmin.php" name="frmlab" class="form-sample">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="txtaname" placeholder="Enter Admin Name" class="form-control" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="txtph" placeholder="Enter Phone No" class="form-control" pattern=[0-9]{10} title="Ten Numbers Only" required />
                          </div>
                        </div>
                      </div>
</div>
                ...
                <div class="row">
                  <div class="col-md-12" align="center">
                    <button type="submit" class="btn btn-primary btn-fw">Add Sub-Admin</button>
                  </div>
                  </form>
                </div>
              </div>
