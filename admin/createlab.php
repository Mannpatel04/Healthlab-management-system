...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="assets/images/symbol.ico.png" />
  </head>
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Insert Lab </h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" action="reqlab.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                         <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" name="txtlname" placeholder="Enter Lab Name" class="form-control" required />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <input type="text" name="txtreg" placeholder="Enter Registration No"class="form-control" required />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="txtowner" placeholder="Enter Owner Name" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="txtphoneno" placeholder="Enter Phone no" pattern=[0-9]{10} title="Ten Numbers Only" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <textarea name="txtspecialities" cols="50" rows="3" class="form-control" placeholder="Enter Specialities"></textarea>
                            </div>
                          </div>
                        </div>
                       ...
                       <button type="submit" class="btn btn-primary btn-fw" >Add Laboratory</button>
						 </div>
                    </form>
                  </div>
                </div>
