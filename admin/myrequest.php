        ...
        <div class="content-wrapper">
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">List Of Pending Request</h4>
                  <div class="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $q = "select request.reqid as rid ,request.*,labs.labid,labs.labname from request,labs where request.status='Pending' and request.labid=labs.labid and request.area='$area1' and request.tstatus='Completed'";
                        ...
                        ?>
                            <tr>
                              ...
                              <td><?php echo $area; ?></td>
                              <td><?php echo "<a href=viewdetail.php?rid=" . $rid1 . ">View</a>" ?></td>
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">List Of Completed Request</h4>
                  <div class="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        //echo $area1;
                        include "myconnection.php";
                        $q = "select request.reqid as rid ,request.*,labs.labid,labs.labname from request,labs where request.status='Completed' and request.labid=labs.labid and request.area='$area1'";
                        $rexist = mysqli_query($connection, $q) or die("Error1");
                        $count = mysqli_num_rows($rexist);
                        if ($count > 0) {
                          while ($arr = mysqli_fetch_array($rexist)) {
