        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"><b> COVID-19 </b></h3>
              <div>
              <h4 class="page-title"><b> Real Time PCR </b></h4>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" action="reqcovid.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                        ...
                        <tr>
                            <td>RdRp gene</td>
                            <td><input type="text" name="txtrdrp"  class="form-control" required/></td>
                            <td>Positive/negative</td>

                        </tr>    
                        <tr>
                            <td>E gene</td>
                            <td><input type="text" name="txtgene"  class="form-control" required/></td>
                            <td>Positive/negative</td>
                        </tr>  
                        <tr>
                            <td>RNase</td>
                            <td><input type="text" name="txtrnase"  class="form-control" required/></td>
                            <td>Pass/Fail</td>
                        </tr>      
                        <tr>
                            <td>SARS-COV-2 RNA</td>
                            <td><input type="text" name="txtsars"  class="form-control" required/></td>
                            <td>Positive/negative</td>
                        </tr>   
                        <tr>
                          <td>
