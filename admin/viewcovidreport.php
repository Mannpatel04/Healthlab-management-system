        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Covid-19 </h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    $qins="select * from covid where reqid='$reqid'";
                    ...
                    <form method="post" action="reqcovid.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                        ...
                        <tr>
                            <td>RdRp gene</td>
                            <td><?php echo $arr['rdrp'] ?></td>
                           

                        </tr>    
                        <tr>
                            <td>E gene</td>
                            <td><?php echo $arr['gene'] ?></td>
                            
                        </tr>  
                        <tr>
                            <td>RNase P(IC)</td>
                            <td><?php echo $arr['rnase'] ?></td>
                            
                        </tr>      
                        <tr>
                            <td>SARS-COV-2 RNA</td>
                            <td><?php echo $arr['sars'] ?></td>
                    ...
                    echo "<a href=pdf.php?type=covid&rid=". $reqid.">Generate PDF</a>";
                    ?>
                  </div>
                </div>
              </div>
