                    ...
                    <form method="post" action="reqthyroid.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="txtt3"  class="form-control" required/></td>
                            <td>ng/mL</td>
                            <td>0.6-1.81</td>
                        ...
                        <tr>
                            <td>T4(Thyroxine)</td>
                            <td><input type="text" name="txtt4"  class="form-control" required/></td>
                            <td>ug/dL</td>
                            <td>4.5-12.6</td>
                        </tr>  
                        <tr>
                            <td>TSH(Ultra Sensitive)</td>
                            <td><input type="text" name="txttsh"  class="form-control" required/></td>
                            <td>uil/mL</td>
                            <td>0.55-4.78</td>
                        </tr>      
