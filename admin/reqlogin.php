            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<li><a class="nav-link" href="#appointment">Registration</a></li>
                        <li><a class="nav-link" href="createlab.html">Create lab</a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					...
					if($role=="Admin")
					{
					$q="select * from admin where email='$em' and password='$pass'";
					}
					else if($role=="Lab")
					{
						$q="select * from labs where email='$em' and password='$pass'";
					}
					else{
						$q="select * from collectorinformation where email='$em' and password='$pass'";	
					}
