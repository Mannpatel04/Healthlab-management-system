                  ...
                  <div class="card-body">
                    ...
                    <form method="post" action="reqdangue.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                        ...
                        <tr>
                            <td>HCT(PCV)</td>
                            <td><input type="text" name="txthct"  class="form-control" required/></td>
                            <td>%</td>
                            <td>40-54</td>
                        </tr>
                        <tr>
                            <td>MCV</td>
                            <td><input type="text" name="txtmcv"  class="form-control" required/></td>
                            <td>fl</td>
                            <td>80-100</td>
                        </tr>
                        <tr>
                            <td>MCH</td>
                            <td><input type="text" name="txtmch"  class="form-control" required/></td>
                            <td>pg</td>
                            <td>27-34</td>
                        </tr>
                        <tr>
                            <td>MCHC</td>
                            <td><input type="text" name="txtmchc"  class="form-control" required/></td>
                            <td>g/dl</td>
                            <td>30-36</td>
                        </tr>
                        <tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td>Neutrophil</td>
                            <td><input type="text" name="txtneu"  class="form-control" required/> </td>
                            <td>%</td>
                            <td>50-70</td>
                        ...
                        <tr>
                            <td>Lymphoyte</td>
                            <td><input type="text" name="txtlym"  class="form-control" required/> </td>
                            <td>%</td>
                            <td>20-40</td>
                        ...
                        <tr>
                            <td>Monocyte</td>
                            <td><input type="text" name="txtmono"  class="form-control" required/> </td>
                            <td>%</td>
                            <td>3-6</td>
