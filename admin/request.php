                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $q = "select request.*,labs.labid,labs.labname from request,labs where request.status='Pending' and request.labid=labs.labid";
