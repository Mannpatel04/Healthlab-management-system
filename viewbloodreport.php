                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    include "myconnection.php";
                     $em1=$_SESSION['una'];
                     $ridd=$_GET['reqid'  ];
                     $q = "select * from request where email='$em1' and reqid='$ridd' ";
                    ...
                    include "myconnection.php";
                    $qins="select * from bloodreport where reqid='$rid1'";
                    ...
                    <form method="post" action="reqbloodcount.php" name="frmlab" class="form-sample">
					 ...
					 <div class="row">
                         ...
                         <tr align="center"><td colspan=4><b><u>Blood Report</u></b></td></tr>
                         <tr>
                            <td>Email</td>
                  ...
                  <?php
                      echo "<a align=center href=./admin/".$ridd.".pdf>Download</a>";
                      ?>
                </div>
              </div>
            </div>
